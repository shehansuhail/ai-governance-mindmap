...
function App() {
  return (
    <div className="p-4 overflow-x-auto">
      <Tree label={<Card className="p-4 text-lg font-bold bg-blue-100 shadow">AI Governance Themes</Card>}>
        <MindMapNode
        ...
        <MindMapNode
          ...
          frameworks={[
            "ISO 42001: 8.6",
            "ISO 27002: 8.10–8.12",
            "NIST RMF: Govern, Manage",
            "SOC 2: CC6.1–6.3, CC8.1",
            "EU AI Act: Art. 10",
          ]}
        />
        <MindMapNode
